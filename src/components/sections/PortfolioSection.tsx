    ...
    <div className="relative overflow-hidden py-2">
      ...
      >
        {duplicatedImages.map((image, index) => (
          <div
            key={index}
            className="relative flex-shrink-0 w-[280px] h-[380px] md:w-[320px] md:h-[420px] rounded-2xl overflow-hidden group"
          >
            <img
              src={image}
  ...
  return (
    <section id="portfolio" className="py-24 lg:py-32 bg-gradient-to-b from-background via-card/30 to-background relative overflow-hidden">
      ...
      <div className="space-y-4 relative">
        ...
        <MarqueeRow images={row2Images} direction="right" speed={35} />
        
        {/* Row 3 - Scrolling Left (different speed) */}
        <MarqueeRow images={row3Images} direction="left" speed={45} />
